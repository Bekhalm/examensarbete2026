...
const PERMANENT_SOURCE_URL_SET = new Set(PERMANENT_SOURCE_URLS);

function isPermanentUrl(url) {
    return PERMANENT_SOURCE_URL_SET.has(url);
}

module.exports = { PERMANENT_SOURCE_URLS, PERMANENT_SOURCE_URL_SET, isPermanentUrl };
